...
app.post('/code',function(req,res){
	...
	exec("gcc -o " + path.join( __dirname,'../workspace', userid, filename+".out") +' '+ path.join(__dirname, '../workspace', userid, filename) + " && " + path.join(__dirname, '../workspace', userid, filename+".out"), function(error, stdout, stderr) {
		if (error !== null) {
			console.log("exec error: " + error);
